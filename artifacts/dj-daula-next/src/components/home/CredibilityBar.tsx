  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
        style={{
          background: 'radial-gradient(ellipse at 50% 130%, rgba(206,31,31,0.06) 0%, transparent 55%)',
        }}
      />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-daula-gray-mid" role="list">
            {STATS.map((stat) => (
              <div
                ...
                role="listitem"
              >
                <p className="text-3xl md:text-4xl font-black tabular-nums leading-none" style={{ color: '#CE1F1F', textShadow: '0 0 12px rgba(206,31,31,0.5)' }}>
